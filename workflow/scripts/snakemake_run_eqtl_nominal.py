...
nominal_comand = f"python -m tensorqtl {genotype_stem} {expression} {eqtl_output_dir}{tissue_id}/{tissue_id}.v8.cluster_genes --covariates {covariates} --mode cis_nominal"
try:
    # Run the command
